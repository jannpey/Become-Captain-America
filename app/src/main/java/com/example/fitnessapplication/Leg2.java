...
public class Leg2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countdownText = findViewById(R.id.Leg2Text);
        countdownButton = findViewById(R.id.Leg2StartButton);
        countdownButtonReset = findViewById(R.id.Leg2RestButton);
