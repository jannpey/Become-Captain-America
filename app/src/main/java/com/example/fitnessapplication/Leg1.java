...
public class Leg1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        countdownText = findViewById(R.id.Leg1Text);
        countdownButton = findViewById(R.id.Leg1StartButton);
        countdownButtonReset = findViewById(R.id.Leg1RestButton);
    ...
    public void NextExercise2(View view) {
        startActivity(new Intent(getApplicationContext(), Leg2.class));//When the button pressed it will move to Leg 2 Page
        finish();
    }
}
