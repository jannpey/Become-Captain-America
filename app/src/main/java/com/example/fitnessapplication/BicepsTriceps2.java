...
public class BicepsTriceps2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_biceps_triceps2);
        countdownText = findViewById(R.id.Biceps2Text);
        countdownButton = findViewById(R.id.Biceps2StartButton);
        countdownButtonReset = findViewById(R.id.Biceps2RestButton);
